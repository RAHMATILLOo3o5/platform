...
<section class="menuWrap">
    <div class="menu">
        ...
        <div class="info">
            ...
            <p>
                Ver 0.0.2 -
                <a href="https://en.wikipedia.org/wiki/Telegram_(messaging_service)">About</a>
            </p>
            <p>
                Layout coded by:
                <a href="https://www.github.com/mayrinck">Mayrinck</a>
            </p>
        </div>
    </div>
</section>
...
<section class="config">
    ...
    <section class="configSect second">
        ...
        <div class="information">
            <ul>
                <li>
                    Phone Number: <span class="blue phone">+1 12 1234 5678</span>
                </li>
...
<!-- -------------------------------- -->
<div class="alerts">Trying to reconnect...</div>
<!-- partial -->